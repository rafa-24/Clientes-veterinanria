export default function Patients({ patient, deletePatient, updatePatients }) {
      return (
            <div className="m-3 bg-white shadow-md px-5 py-5 rounded-xl">
                  ...
                  <div className="flex">
                        ...
                        <button onClick={() => updatePatients(patient)} className="bg-yellow-500  text-white font-bold py-2 px-4 rounded ml-2">
                              Editar
                        </button>
                  </div>
            </div>
